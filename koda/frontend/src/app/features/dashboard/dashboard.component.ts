...
@Component({
  ...
  template: `
    ...
    <section class="next-step"><div><p class="eyebrow">Siguiente paso</p><h2>Analiza una nueva radiografia</h2><p>Carga una imagen para iniciar el flujo de diagnostico asistido.</p></div><a routerLink="/analisis/cargar">Cargar estudio</a></section>
  `,
  styles: [`
